...
[![LinkedIn](https://img.shields.io/badge/Connect%20with%20me%20on-LinkedIn-blue.svg)](https://www.linkedin.com/faisaltufail/)
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/faisaltufail007/Two-Tier-AWS-Infrastructure-with-Terraform.git
   cd Two-Tier-AWS-Infrastructure-with-Terraform/
   ```
...
- GitHub: [GitHub Profile](https://github.com/faisaltufail007)
- LinkedIn: [LinkedIn Profile](https://www.linkedin.com/in/faisaltufail/)
